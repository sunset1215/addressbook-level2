...
public class Messages {
    ...
    public static final String MESSAGE_DISPLAY_LIST_OF_TAG_OPERATIONS = "List of all tags added/deleted during this session:";
    public static final String MESSAGE_NO_TAG_OPERATIONS = "No tags added/deleted during this session.";
}
